...
def main():
	...
	try:
		...
		if pilih == '1':
			...
			print
			os.system('xdg-open https://youtube.com/channel/UCbY7jd_8ypWDqCypuiENJ8A')
			sleep(2)
			tanya = raw_input(W+'Udah Subscribe Belum ?'+C+' ^_^'+W+' ['+C+'Y'+W+'/'+C+'n'+W+']'+C+' : '+W+'')
			if tanya.upper() == 'done':
				print
				print(W+'Thank you very much'+C+' ^_^')
				sys.exit() 
...
if __name__ == '__main__':
	os.system(clear)
	print(C+'Subscribe YT'+W+' Saya Dlu Ya Bre !'+C+' :v')
	print
	os.system('xdg-open https://youtube.com/channel/UCbY7jd_8ypWDqCypuiENJ8A')
	sleep(2)
	tanya = raw_input(W+'Udah Subscribe Belum ?'+C+' ^_^'+W+' ['+C+'Y'+W+'/'+C+'n'+W+']'+C+' : '+W+'')
	if tanya.upper() == 'Y':
		...
		print
		print(W+'sumpah ggk pph yakin'+C+' ^_^')
		sleep(2)
		main()
